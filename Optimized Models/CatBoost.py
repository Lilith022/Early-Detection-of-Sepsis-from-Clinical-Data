...
def objective(trial):
    ...
    return 3 * sensitivity + 1 * f1 + 0.5 * auc_score  # Priorizar sensitivity
...
# Si es lista, tomar clase positiva
...
output_dir = "/mnt/Home-Group/csantos_cps/JosmanDeisy/Modelos/PDFs_Gradient_05_09"
...
# Guardar modelo
optuna_model.save_model(os.path.join(output_dir, "mejor_modelo.cbm"))
